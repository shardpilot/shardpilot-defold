...
# publication CANDIDATES — repositories that are private
...
EOF
  ...
  (
    ...
    printf '%s\n' '-- GAP-000 note' 'return {}' > lane_b.lua
...
echo "LANE A (GATED) — non-source tracked files: clean (${scan_lane_a_files} of ${scan_files} tracked file(s) scanned; the rest are Lua source, reported in lane B)."
